    ...
    <div class="flex flex-wrap gap-4 w-full">
        ...
        {{-- @dd(Str::slug($post->slug)) --}}
            ...
            <div class=" flex-auto bg-white p-8 w-[32rem] shadow-lg rounded"> 
                ...
                <!-- Button -->
                <a href="{{ route('blogs.show', $post->slug) }}" class="bg-green-600 text-white font-semibold py-2 px-5 text-sm mt-6 inline-flex items-center group">
                <p> READ MORE </p>
                ...
                <a href="{{ route('blogs.destroy', $post->slug) }}" class="bg-red-600 text-white font-semibold py-2 px-5 text-sm mt-6 inline-flex items-center group">
                <p> DELETE </p>
                </a>
