        ...
        <div class="-mx-3 flex flex-wrap">
            ...
            <div class="w-full px-3">
                <div class="mb-5">
                    ...
                    <textarea name="alamat" id="" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#86efac] focus:shadow-md" cols="30" rows="5" placeholder="Address..."></textarea>
                </div>
            </div>
            <div class="w-full px-3">
                <div class="mb-5">
                    ...
                    <textarea name="deskripsi" id="" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#86efac] focus:shadow-md" cols="30" rows="5" placeholder="Description..."></textarea>
                </div>
            </div>
